...
VALUES
  (1, "admin@hotmail.com", "aad0ef68340263392332ec8ed8bd8166", "Admin", "Admin",1);

INSERT INTO users
  (id_user, username, password, first_name, second_name, user_type)
VALUES
  (2, "mariana@hotmail.com", "5b9dc1ca6c4160be36ad121ab0cf7331", "Mariana", "Hinojosa",2);

INSERT INTO users
  (id_user, username, password, first_name, second_name, user_type)
VALUES
  (3, "fher@hotmail.com", "351b5579d6de6fbf9bd5b8053f4347d4", "Fher", "Torres",2);
